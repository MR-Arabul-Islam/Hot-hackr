#open source by MR Arabul Islam
# Github MR-Arabul-Islam
...
logo=(""" \033[1;37m ##     ##   ########  ########  ########  
  ...
  \033[1;30m ##   ##    ##        ##        ##    ##   
   \033[1;32m ## ##     ##        ##        ##     ##  
    \033[1;34m ###      ########  ########  ##      ##   
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  ARABUL
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  আরাবুল ইসলাম 
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100087079881481&mibextid=ZbWKwL');menu()
                        elif xd in ['4','04']:
                        	     os.system('xdg-open https://chat.whatsapp.com/BUhKqb3oiow5D1Vf2f6NOg');menu()
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM VEER TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/Md. Sohanur');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE VEER TOOL');time.sleep(2);linex();exit() 
                        else:
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/MR-Arabul-Islam/Good.txt/blob/main/Good.txt').text
    if id in httpCaht:
      print("\x1b[1;97mYOUR KEY IS A APPROVED.")
      msg = str(os.geteuid())
      time.sleep(0.5)
      main__manu()
      pass
      ...
      tks = ('Hello%20Mr.Hackr.X%20Iam%20your%20student%20Hackr%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+19517900632?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
